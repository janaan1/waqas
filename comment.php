...
return ' '.$jam.':D KίɴĢ BΘτ Tελɱ Oɴ Fίʀε :D

💙 BOT K BADSHAH 💙 KING BOT TEAM 💙 WAQAS BABAR 💙 CHAUDHRAY WAQAS 💙 HAMZA RAWAL 💙 UMER CHAUDHRY 💙 MUHAMMAD SALAIH ZUBAIR 💙 RAJA BILAL 💙 MALIK ARYAN 💙 SAQIB ALI 💙 ABDUL REHMAN 💙 WAQAS BUTT 💙 MALIK ALI SHIKRA 💙 SUNNY AWAN 💙 ZAALIM KHAN 💙 CH TOQER 💙 HASEEB BUTT 💙 SITE ~> PARU-XD.TK 💙'.$hr;
}
...
CURLOPT_USERAGENT => 'DESCRIPTION BY *WAQAS BABAR*',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
...
$pen=opendir('waqasdadxd');
while($on=readdir($pen)){
if($on != '.' && $on != '..'){
$slout[]=$on;}
}
foreach($slout as $me){
$true=file_get_contents('waqasdadxd/'.$me);
$break=explode('*',$true);
